...
private:
	...
	BasicTile* add_basic_tile(Vector2i rect, int j, int i, Vector2i tileset_pos, BasicTile::COLLIDE_TYPE collide = BasicTile::COLLIDE_TYPE::TOTAL);
	void add_mario(int j, int i, Vector2i tileset_pos);
	void add_coin(int j, int i, Vector2i tileset_pos);
	void add_myster_block(int j, int i, Vector2i tileset_pos, bool coin);
	void add_koopa(int j, int i, Vector2i tileset_pos);
	void add_magikoopa(int j, int i, Vector2i tileset_pos);
